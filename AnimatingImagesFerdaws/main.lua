-- Tittle: Animating Images
-- Name:Ferdaws
-- Course: ICS20/3C
-- This program display's 3 images,one fades,one move diagonally and last one grows in size.
-----------------------------------------------------------------------------------------------------
-- TASK BAR hide
------------------------------------------------------------------------------------------------------------
-- hide the status bar 
...
--------------------------------------------------------------------------------------------------------------------------------
snoopDogg.x = 0
snoopDogg.y = display.contentHeight/3
...
--------------------------------------------------------------------------------------------------------------------
--DIAGONALLY MOVE SECTION
-----------------------------------------------------------------------------------------------------
scrrolSpeed2 = 3
tupac.alpha = 1

local function MoveTupac(event)

	tupac.y = tupac.y + scrrolSpeed2

	tupac.alpha = tupac.alpha + 0.01
end

Runtime:addEventListener("enterFrame", MoveTupac)
--------------------------------------------------------------------------------------------------------------
-- GROW IN SIZE
--------------------------------------------------------------------------------------------------------------------
